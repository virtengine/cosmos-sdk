...
func TestDecodeStore(t *testing.T) {
	...
	proposalA, err := types.NewProposal(content, []sdk.Msg{}, 1, endTime, endTime.Add(24*time.Hour))
	require.NoError(t, err)
	proposalB, err := types.NewProposal(content, []sdk.Msg{}, 2, endTime, endTime.Add(24*time.Hour))
	require.NoError(t, err)
